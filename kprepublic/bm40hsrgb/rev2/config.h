...
#    define RGB_MATRIX_MAXIMUM_BRIGHTNESS 200 // Limit to vendor-recommended value  DEFAULT 180
...
#    define ENABLE_RGB_MATRIX_MULTISPLASH  // normally after ENABLE_RGB_MATRIX_SPLASH
